                        ...
                        <div class="row m-t-25">
                          <div class="col-sm-6 col-lg-3 col-xl-12">
                                <div class="card">
                                        ...
                                        <h1 align="center">¡UPS! Error 404</h1>
                                        <div align="center">
                                        <img src="images/lupa-error.png" alt="" height="300" width="300">
                                        </div>
                                        <h2>Parece que la página que buscas no esta disponible.</h2>
                                        <h3>Intenta en nuestra página de inicio: <a href="index.php">Home</a>  </h3>
                                    </div>
								                 </div>
                            </div>
